const GlobalStyles = () => (
  <style>{`
    ...
    [data-theme="pure"] {
      ...
      --bg-tertiary: #B0A89F;
      --bg-card: #DBD7D2;
      --bg-card-hover: #C8C2BA;
      --bg-nav: rgba(219, 215, 210, 0.95);
      --text-primary: #000000;
      --text-secondary: #2C2825;
      --text-muted: #5A504A;
      ...
      --rank2-bg: #DBD7D2;
      --rank3-bg: #DBD7D2;
      --rank1-shadow: 0 2px 8px rgba(0, 0, 0, 0.12);
      --rank2-shadow: 0 2px 8px rgba(0, 0, 0, 0.10);
      --rank3-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);
    }
