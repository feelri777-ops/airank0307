      ...
      <PostCard>
        ...
        <MetaRow>
          ...
          <MetaText>
            ...
            <PostInfo>
              {formatRelativeTime(post.createdAt)} · 조회 {post.views || 0}
            </PostInfo>
          </MetaText>
          {isOwner && (
            <OwnerActions>
              <SmallButton onClick={() => navigate(`/community/${postId}/edit`)}>
                수정
              </SmallButton>
              <SmallButton $danger onClick={handleDelete}>
                삭제
              </SmallButton>
            </OwnerActions>
          )}
              ...
              <CommentItem key={c.id}>
                ...
                <CommentBody>
                  <CommentMeta>
                    ...
                    {user && user.uid === c.uid && (
                      <DeleteCommentBtn onClick={() => handleDeleteComment(c.id)}>
                        삭제
                      </DeleteCommentBtn>
                    )}
                  </CommentMeta>
