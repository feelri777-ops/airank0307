  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
      <div style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ fontSize: "0.96rem", color: "var(--text-muted)", margin: 0 }}>AIRANK 서비스의 전체 운영 데이터를 한눈에 확인합니다.</p>
      </div>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: "1.44rem", fontWeight: 800, color: "var(--text-primary)", marginBottom: "1rem" }}>운영 도구 바로가기</h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "10px" }}>
          {[
            ...
            >
              <div style={{ fontWeight: 800, color: "var(--text-primary)", fontSize: "1.04rem" }}>{label}</div>
