...
const ICONS = {
  ...
  'caret-up':       PI.CaretUp,
  'caret-down':     PI.CaretDown,
  'trend-up':       PI.TrendUp,
  'cpu':            PI.Cpu,
  'wrench':         PI.Wrench,
  'megaphone':      PI.Megaphone,
  'lightning':      PI.Lightning,
  'chart-line-up':  PI.ChartLineUp,
  'lightbulb':      PI.Lightbulb,
  'youtube-logo-fill': PI.YoutubeLogoFill,
  'bookmark-simple': PI.BookmarkSimple,
  'bookmark-simple-fill': PI.BookmarkSimpleFill,
  'sparkle':        PI.Sparkle,
  'pencil-simple':  PI.PencilSimple,
  'trash-simple':   PI.TrashSimple,
