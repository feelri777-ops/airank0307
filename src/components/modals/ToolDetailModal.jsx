...
const ToolDetailModal = ({ tool, rank, prevRank, onClose }) => {
  ...
  const card1 = (
    <div style={{
      ...
      <button onClick={toggleBookmark} title={user ? (bookmarked ? "북마크 해제" : "북마크 저장") : "로그인 후 북마크 가능"} style={{ position: "absolute", top: "10px", right: "46px", background: bookmarked ? "var(--accent-indigo)" : "var(--bg-tertiary)", border: `1px solid ${bookmarked ? "var(--accent-indigo)" : "var(--border-primary)"}`, borderRadius: "5px", width: "28px", height: "28px", cursor: "pointer", fontSize: "0.85rem", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.2s ease", color: bookmarked ? "#fff" : "var(--text-muted)", zIndex: 1 }}>{bookmarked ? "✓" : ""}</button>
      ...
      <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 1000, background: "rgba(0,0,0,0.55)", backdropFilter: "blur(4px)", overflowY: "auto", display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "40px 16px" }}>
        <div onClick={(e) => e.stopPropagation()} style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", alignItems: "flex-start", justifyContent: "center", gap: "16px", width: "100%", maxWidth: "1000px", margin: "auto" }}>
          <div style={{ background: "var(--bg-card)", border: "1px solid var(--border-primary)", borderRadius: "var(--r-md)", padding: "1.5rem", width: DESKTOP_CARD_WIDTH, flexShrink: 0, boxShadow: "0 24px 64px rgba(0,0,0,0.25)", position: "relative", height: "fit-content" }}>
            ...
            <button onClick={toggleBookmark} title={user ? (bookmarked ? "북마크 해제" : "북마크 저장") : "로그인 후 북마크 가능"} style={{ position: "absolute", top: "16px", right: "56px", background: bookmarked ? "var(--accent-indigo)" : "var(--bg-tertiary)", border: `1px solid ${bookmarked ? "var(--accent-indigo)" : "var(--border-primary)"}`, borderRadius: "5px", width: "32px", height: "32px", cursor: "pointer", fontSize: "1rem", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.2s ease", color: bookmarked ? "#fff" : "var(--text-muted)" }}>{bookmarked ? "✓" : ""}</button>
